    ...
    return (
        ...
        | {
            ...
            "separate_debug_info": attrs.bool(default = False, doc = """
                Ship this binary with its debug information separated out of band (an
                ELF `.debuginfo` gnu-debuglink sidecar or a Mach-O `.dSYM` bundle),
                surfaced at the `[debuginfo]` sub-target.
            """),
